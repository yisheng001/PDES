...
void Problem_1(int k)
{
	...
	double dt = lamda * h;
	int N = 1.0 / dt;
	double t1 = 0.1, t2 = 0.4, t3 = 0.8, t4 = 1.0;
	int n1 = t1 / dt, n2 = t2 / dt, n3 = t3 / dt, n4 = t4 / dt;
	...
	delete[]p0, p1, p2, p3, p4;
}
void Problem_2(int J)
{
	int K = 3;
	double h = 1.0 / J;
	double lamda = 0.5;
...
int main()
{
	//Problem_1(3);//K=1时为FTCS，K=2时为Lax_Friedrich,K=3时为Lax_Wendroff，PG4_1_1
	Problem_2(160);//PG4_1_2
}